...
const Experience = () => {
  ...
  const [cards, setCards] = useState<Array<experiences> | null>(null);
        ...
        {cards && cards?.length > 0 ? (
          ...
          <>
            {currUser.id == userStore.id ? (
              ...
              >
                <ExpAdd title="Add an Experience" />
              </Link>
            ) : (
              <>
                <span className="mt-12 font-semibold text-[42px] text-[rgb(68,61,81)]">
                  This User do not have any Experience added yet
                </span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="100"
